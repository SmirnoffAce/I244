...
$selecttable = "SELECT * FROM bbrokan_loomaaed";
...
$q1 = mysqli_query($connection, "SELECT * FROM bbrokan_loomaaed WHERE puur='1'");
echo "<p>Puuris number 1 elavad: </p>";
while($row = $q1->fetch_assoc()) {
    echo $row['nimi']." ";
}
$q1 = mysqli_query($connection, "SELECT * FROM bbrokan_loomaaed WHERE puur='3'");
echo "<p>Puuris number 3 elavad: </p>";
while($row = $q1->fetch_assoc()) {
    echo $row['nimi']." ";
}
$q1 = mysqli_query($connection, "SELECT * FROM bbrokan_loomaaed WHERE puur='6'");
...
$q1=mysqlQuery("SELECT MAX(vanus) AS `max` FROM bbrokan_loomaaed");
$q2=mysqlQuery("SELECT MIN(vanus) AS `min` FROM bbrokan_loomaaed");
...
$q1=mysqlQuery("SELECT COUNT(*) AS `count` FROM bbrokan_loomaaed WHERE puur='1'");
echo "<p>Puuris number 1 loomade arv on : ".$q1['count']."</p>";
$q1=mysqlQuery("SELECT COUNT(*) AS `count` FROM bbrokan_loomaaed WHERE puur='3'");
echo "<p>Puuris number 3 loomade arv on : ".$q1['count']."</p>";
$q1=mysqlQuery("SELECT COUNT(*) AS `count` FROM bbrokan_loomaaed WHERE puur='6'");
echo "<p>Puuris number 6 loomade arv on : ".$q1['count']."</p>";
$q1=mysqlQuery("SELECT COUNT(*) AS `count` FROM bbrokan_loomaaed WHERE puur='7'");
echo "<p>Puuris number 7 loomade arv on : ".$q1['count']."</p>";
$q1=mysqlQuery("SELECT COUNT(*) AS `count` FROM bbrokan_loomaaed WHERE puur='11'");
