...
<html>
	...
	<body>
		<div id="vorm">
			...
			<br>
			<textarea name="text" placeholder="Siia kirjuta kommentaar" required></textarea>
			<br><br>
			<input type="color" name="bg_color"> Taustavarv
			<br><br>
			<input type="color" name="color"> Tekstivarv
			<br><br>
			<input type="number" name="size" min="12" max="72" value="12"> Teksti suurus (12-72px)
			<br><br>
			Piirjoon
			<br><br>
			<input type="number" name="borderw" min="0" max="20"> Piirjoone laius (0-20px)
			<br><br>
			...
			<br><br>
			<input type="color" name="bordercol"> Piirjoone varv
			<br><br>
			<input type="number" name="borderradius" min="0" max="100"> Piirjoone nurga raadius (0-100px)
			<br><br>
